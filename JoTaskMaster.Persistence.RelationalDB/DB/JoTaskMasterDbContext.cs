...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-55KITNB;Database=JoTaskMasterDBB;TrustServerCertificate=True;Trusted_Connection=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TaskResponse>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("TaskResponse");
        ...
        modelBuilder.Entity<UserTask>(entity =>
        {
            ...
            entity.HasOne(d => d.TaskUserNavigation).WithMany(p => p.UserTasks)
